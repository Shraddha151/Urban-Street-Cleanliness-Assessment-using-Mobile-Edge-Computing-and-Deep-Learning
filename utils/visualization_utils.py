...
def draw_bounding_box_on_image_array(image,
  ...
  print("Display string",display_str_list)
...
def draw_bounding_box_on_image(image,
  ...
  print("display string list=",display_str_list)
...
def draw_bounding_boxes_on_image_array(image,
  ...
  """
  print("display string list list==",display_str_list_list)
...
def draw_bounding_boxes_on_image(image,
  ...
  Raises:
    ValueError: if boxes is not a [N, 4] array
  """
  print("display string list list==2",display_str_list_list)
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          display_str = '{}: {}%'.format(
              class_name,
              int(100*scores[i]))
          print("Display srting",display_str)
        else:
